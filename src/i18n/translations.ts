...
export const translations = {
  fr: {
    ...
    gallery: {
      ...
      item1: { title: "Prise de RDV", subtitle: "SMART BOOKING" },
      item2: { title: "Support Client", subtitle: "LEAD CAPTURE" },
      item3: { title: "Gestion Leads", subtitle: "RÉCEPTION 24/7" },
      item4: { title: "Flux Automatisé", subtitle: "CALENDAR SYNC" },
      item5: { title: "E-commerce", subtitle: "MULTI-LINGUE" },
      item6: { title: "Soutien Scolaire", subtitle: "SUIVI SMS" },
      item7: { title: "Réservation Hôtel", subtitle: "DONNÉES CLIENTS" },
      item8: { title: "Assistance Juridique", subtitle: "RELAIS ÉQUIPE" },
      item9: { title: "Coach Sportif", subtitle: "EXPÉRIENCE CLIENT" },
      item10: { title: "Agence Voyage", subtitle: "SÉCURITÉ" },
      item11: { title: "Clinique Vétérinaire", subtitle: "INTELLIGENCE" },
      special: {
  ...
  en: {
    ...
    gallery: {
      ...
      item1: { title: "Appointment Booking", subtitle: "SMART BOOKING" },
      item2: { title: "Customer Support", subtitle: "LEAD CAPTURE" },
      item3: { title: "Lead Management", subtitle: "24/7 RECEPTION" },
      item4: { title: "Automated Flow", subtitle: "CALENDAR SYNC" },
      item5: { title: "E-commerce", subtitle: "MULTI-LINGUAL" },
      item6: { title: "Tutoring", subtitle: "SMS FOLLOW-UP" },
      item7: { title: "Hotel Booking", subtitle: "CLIENT DATA" },
      item8: { title: "Legal Assistance", subtitle: "TEAM RELAY" },
      item9: { title: "Personal Trainer", subtitle: "CLIENT EXPERIENCE" },
      item10: { title: "Travel Agency", subtitle: "SECURITY" },
      item11: { title: "Vet Clinic", subtitle: "INTELLIGENCE" },
      special: {
        anvelaTitle: "Anvela AI",
  ...
  es: {
    ...
    gallery: {
      ...
      item1: { title: "Reserva de Citas", subtitle: "RESERVA INTELIGENTE" },
      item2: { title: "Atención al Cliente", subtitle: "CAPTURA DE LEADS" },
      item3: { title: "Gestión de Leads", subtitle: "RECEPCIÓN 24/7" },
      item4: { title: "Flujo Automatizado", subtitle: "SINCRONIZACIÓN" },
      item5: { title: "E-commerce", subtitle: "MULTILINGÜE" },
      item6: { title: "Tutoría", subtitle: "SEGUIMIENTO SMS" },
      item7: { title: "Reserva Hotel", subtitle: "DATOS DE CLIENTES" },
      item8: { title: "Asistencia Legal", subtitle: "RELEVO DE EQUIPO" },
      item9: { title: "Entrenador Personal", subtitle: "EXPERIENCIA CLIENTE" },
      item10: { title: "Agencia Viajes", subtitle: "SEGURIDAD" },
      item11: { title: "Clínica Veterinaria", subtitle: "INTELIGENCIA" },
      special: {
        anvelaTitle: "Anvela AI",
  ...
  it: {
    ...
    gallery: {
      ...
      item1: { title: "Prenotazione Appuntamenti", subtitle: "PRENOTAZIONE SMART" },
      item2: { title: "Supporto Clienti", subtitle: "CATTURA LEAD" },
      item3: { title: "Gestione Lead", subtitle: "RICEVIMENTO 24/7" },
      item4: { title: "Flusso Automatizzato", subtitle: "SINCRONIZZAZIONE" },
      item5: { title: "E-commerce", subtitle: "MULTILINGUA" },
      item6: { title: "Tutoring", subtitle: "FOLLOW-UP SMS" },
      item7: { title: "Prenotazione Hotel", subtitle: "DATI CLIENTI" },
      item8: { title: "Assistenza Legale", subtitle: "RELEVO DI SQUADRA" },
      item9: { title: "Personal Trainer", subtitle: "ESPERIENZA CLIENTE" },
      item10: { title: "Agenzia Viaggi", subtitle: "SICUREZZA" },
      item11: { title: "Clinica Veterinaria", subtitle: "INTELLIGENZA" },
      special: {
        anvelaTitle: "Anvela AI",
