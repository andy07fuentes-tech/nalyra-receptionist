    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          name: "Co-Pilot",
          price: "449",
          weeklyNote: "soit environ 104$ par semaine",
          isPopular: true,
          setupFee: "197",
          setupFeeNote: "Contrat minimum de 3 mois",
        ...
        },
        {
          ...
          description: "On s'occupe de tout — vous n'avez plus à gérer les appels. Chaque appel devient une opportunité.",
          features: [
  ...
  en: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        {
          name: "Anvela Signature",
          tagline: "Complete system, turnkey",
          price: "697",
          weeklyNote: "approx. $165 / week",
          setupFee: "497",
          setupFeeNote: "Minimum 6-month commitment",
          description: "We handle everything — you no longer have to manage calls. Every call becomes an opportunity.",
          features: [
  ...
  es: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        {
          name: "Anvela Signature",
          tagline: "Sistema completo, llave en mano",
          price: "697",
          weeklyNote: "aprox. $165 / semana",
          setupFee: "497",
          setupFeeNote: "Contrato mínimo de 6 meses",
          description: "Nos encargamos de todo — ya no tienes que gestionar las llamadas. Cada llamada se convierte en una oportunidad.",
          features: [
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          name: "Co-Pilot",
          price: "449",
          weeklyNote: "circa 104$ a settimana",
          isPopular: true,
          setupFee: "197",
          setupFeeNote: "Contratto minimo 3 mesi",
        ...
        {
          name: "Anvela Signature",
          tagline: "Sistema completo, chiavi in mano",
          price: "697",
          weeklyNote: "circa 165$ a settimana",
          setupFee: "497",
          setupFeeNote: "Contratto minimo 6 mesi",
          description: "Ci occupiamo di tutto — non devi più gestire le chiamate. Ogni chiamata diventa un'opportunità.",
          features: [
