...
export function WineryCarousel() {
  ...
  // Define slides from translations
  const slides = [
    {
      image: '/images/step-setup.jpg',
      title: t('howItWorks.slides.setup.title'),
      subtitle: t('howItWorks.slides.setup.subtitle'),
      area: "5",
      unit: t('howItWorks.slides.setup.unit'),
      description: t('howItWorks.slides.setup.description'),
    },
    {
      image: '/images/step-integrate.jpg',
      title: t('howItWorks.slides.integrate.title'),
      subtitle: t('howItWorks.slides.integrate.subtitle'),
      area: "50+",
      unit: t('howItWorks.slides.integrate.unit'),
      description: t('howItWorks.slides.integrate.description'),
    },
    {
      image: '/images/step-launch.jpg',
      title: t('howItWorks.slides.launch.title'),
      subtitle: t('howItWorks.slides.launch.subtitle'),
      area: "24",
      unit: t('howItWorks.slides.launch.unit'),
      description: t('howItWorks.slides.launch.description'),
    },
  ];
      ...
      <div className="container-custom relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-0 items-stretch">
            ...
            <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[500px] rounded-lg lg:rounded-r-none overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 flex gap-3 z-20">
                <button
                  onClick={prevSlide}
                  className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-blue-500 hover:border-blue-500 transition-all duration-300"
              ...
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 text-blue-500 text-sm mb-4">
                    ...
                    <span>{t('howItWorks.locationTag')}</span>
                  </div>
                  ...
                  <div className="flex items-baseline gap-2 mb-6">
                    <span className="font-serif text-5xl lg:text-6xl text-blue-500">
                      {slide.area}
                    </span>
                  ...
                  <button
                    ...
                    aria-label={t('nav.ctaButton') as string}
                  >
                    {t('nav.ctaButton')}
                  </button>
                </div>
        ...
        <div className="fade-up mt-8 flex justify-center lg:justify-start" style={{ transitionDelay: '0.2s' }}>
          <div className="flex items-center gap-4 text-sm">
            <span className="font-serif text-2xl text-blue-500">
