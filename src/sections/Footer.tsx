...
const QuebecFlag = () => (
  <svg 
    ...
    viewBox="0 0 300 200" 
    className="w-5 h-auto inline-block rounded-[1px] shadow-sm flex-shrink-0"
    aria-hidden="true"
  >
    <rect width="300" height="200" fill="#003399"/>
    <path d="M0 83.33h300v33.34H0zM133.33 0h33.34v200h-33.34z" fill="#fff"/>
    {/* Fleur-de-lis - Simplified and crisp for small sizes */}
    {[
      { x: 66.67, y: 41.67 },   // Top Left
      { x: 233.33, y: 41.67 },  // Top Right
      { x: 66.67, y: 158.33 },  // Bottom Left
      { x: 233.33, y: 158.33 }  // Bottom Right
    ].map((pos, i) => (
      <g key={i} transform={`translate(${pos.x},${pos.y}) scale(0.45)`}>
        <path 
          d="M0-30c0 0-12 25-12 35s12 10 12 10 12 0 12-10-12-35-12-35z M-18 5c0 0 10 0 20 15s-5 10-15 10-15-5-15-20c0-10 10-5 10-5z M18 5c0 0-10 0-20 15s5 10 15 10 15-5 15-20c0-10-10-5-10-5z" 
          fill="#fff" 
        />
        <rect x="-15" y="12" width="30" height="4" fill="#fff" rx="1"/>
      </g>
    ))}
  </svg>
);
      ...
      <div className="bg-white pt-24 pb-12 relative overflow-hidden">
        <div className="container-custom">
          ...
          <div className="mt-20 relative pointer-events-none select-none overflow-hidden">
            <h2 className="text-[clamp(4rem,18vw,20rem)] font-serif font-medium text-neutral-900 leading-none tracking-normal text-center uppercase">
              Anvela
            </h2>
          </div>
        </div>
